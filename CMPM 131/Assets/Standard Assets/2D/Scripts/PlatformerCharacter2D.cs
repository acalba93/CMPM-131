...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        [SerializeField]private AudioSource t_AudioSource;
        [SerializeField]private AudioClip t_JumpSound;
        [SerializeField]private AudioClip t_HitSound;
        [SerializeField]private AudioClip t_PizzaSound;
        ...
        public void Move(float move, bool crouch, bool jump)
        {
            ...
            if (m_Grounded && jump && m_Anim.GetBool("Ground"))
            {
                ...
                t_AudioSource.clip = t_JumpSound;
                if (!t_AudioSource.isPlaying)
                {
                    t_AudioSource.Play();
                }
            }
		...
		void OnCollisionEnter2D(Collision2D coll) {
			if (coll.gameObject.tag == "Enemy") {
                ...
                t_AudioSource.Stop();
                t_AudioSource.clip = t_PizzaSound;
                t_AudioSource.Play();
                if (Lives<3)Lives++;
				PlayerPrefs.SetString("Lives Remaining: ", Lives.ToString());
				if (Lives == 1) {
